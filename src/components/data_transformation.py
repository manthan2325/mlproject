    ...
    def get_transformer_object(self):
        try:
            ...
            num_pipeline = Pipeline(
                steps = [
                    ("Imputer",SimpleImputer(strategy="median")), ## missing values handled by median
                    ("Scaler",StandardScaler(with_mean=False))
                ]
            )
            cat_pipeline = Pipeline(
                steps = [
                    ("Imputer",SimpleImputer(strategy="most_frequent")), ## missing values handled by most frequent
